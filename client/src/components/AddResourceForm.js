					...
					<form onSubmit={sendEmail}>
						<Row>
							<div className="ar-textarea">
								...
								<p>
									If you are not listed and would like to be added to our database. Please fill out
									the form below. If you have any questions, feel free to send us an email at
							...
							<Col md>
								<div className="row mx-auto">
									...
									<div className="col-8 arform-group pt-5 ">
										...
										<p>
											What do you offer? What are the requirements, if any? Are referrals
											required? List specifics.
										</p>
										<textarea
											className="form-control shadow-none"
											id=""
