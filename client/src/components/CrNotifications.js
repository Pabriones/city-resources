...
function crSaved() {
  document.getElementById("crsave").innerHTML = "SAVED!";
  document.getElementById("crsave").style.backgroundColor = "#659962";
...
class CrNotications extends Component {
  state = {
