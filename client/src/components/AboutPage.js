		...
		<body>
			<div class="container-fluid about-page-container">
				...
				<div class="row about-page-intro">
					This guide was created to help connect those in need to different services like meals, childcare,
					housing, and many more throughout Washington State.
				</div>
				<div class="row about-page-directory-button">
					<Link class="directLink" to="/directory">
						{' '}
			...
			<div class="container-fluid quote">
				<p>
					"Seattle's homelessness crisis has been years in the making, and its roots run deep, touching racial
					inequity, economic disparities, mental health treatment, rising housing costs, mental health,
					addiction, and so much more. We have a responsibility to be honest that this crisis won't go away
					overnight. Lasting, meaningful progress will take years. But we still must act - and are acting - to
					improve life in Seattle."- Mayor Jenny Durkan
				</p>
			</div>
			<div class="parallax">
				<div class="space"> </div>
